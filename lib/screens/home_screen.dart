...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<HouseListing> _houseListings = [
    HouseListing(
      id: 'h1',
      imageUrl: 'https://via.placeholder.com/400x250/FF5733/FFFFFF?text=House+1', // Placeholder image
    ...
    HouseListing(
      id: 'h2',
      imageUrl: 'https://via.placeholder.com/400x250/33A0FF/FFFFFF?text=House+2',
    ...
    HouseListing(
      id: 'h3',
      imageUrl: 'https://via.placeholder.com/400x250/33FF57/FFFFFF?text=House+3',
      location: 'Entebbe',
      rentPrice: 300000.0,
  ...
  void _onItemTapped(int index) {
    ...
    // Todo: implemet navigation to favorites/Profile screens
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: house.availabilityStatus == 'Vacant' ? Colors.green[100] : Colors.orange[100],
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          color: house.availabilityStatus == 'Vacant' ? Colors.green[700] : Colors.orange[700],
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      ...
                      print('View Details for ${house.location} (ID: ${house.id})');
                    },
